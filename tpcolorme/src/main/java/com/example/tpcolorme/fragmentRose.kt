...
class fragmentRose : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            if (random > 50) {
                Navigation.findNavController(view).navigate(R.id.action_fragmentRose_to_fragmentJaune)
            } else {
                Navigation.findNavController(view).navigate(R.id.action_fragmentRose_to_fragmentVert)
            }
        }
    }
